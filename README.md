...
```javascript
import betainc from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-betainc@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-betainc/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/math-base-special-betainc/actions/workflows/test.yml?query=branch:v0.2.3
